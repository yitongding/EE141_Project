...
functs_itype = \
{
    "ADDI":    ("000", "0", lambda a,b: a+b, lambda a: a, lambda b: sext(b&0xffff)),
    "SLTI":    ("010", "0", lambda a,b: (lambda:0, lambda:1)[comp(a,b)](), lambda a: a&0x1f, lambda b: sext(b&0xffff)),
    "SLTIU":   ("011", "0", lambda a,b: (lambda:0, lambda:1)[a < b](), lambda a: a&0x1f, lambda b: sext(b&0xffff)),
    "XORI":    ("100", "0", lambda a,b: a^b, lambda a: a, lambda b: abs(b)&0xffff),
    "ORI":     ("110", "0", lambda a,b: a|b, lambda a: a, lambda b: abs(b)&0xffff),
    "ANDI":    ("111", "0", lambda a,b: a&b, lambda a: a, lambda b: abs(b)&0xffff),
...
functs_rtype = \
{
    ...
    "SLT":     ("010", "0", lambda a,b: (lambda:0, lambda:1)[comp(a,b)](), lambda a: a, lambda b: sext(b&0xffff)),
    "SLTU":    ("011", "0", lambda a,b: (lambda:0, lambda:1)[a < b](), lambda a: a, lambda b: sext(b&0xffff)),
